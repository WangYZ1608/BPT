...
def create_model(args, num_class):
    bpt = ['bpt_vit_b', 'bpt_vit_l', 'bpt_vit_h']
    bpt_deep = ['bpt_deep_vit_b', 'bpt_deep_vit_l', 'bpt_deep_vit_h']
    assert args.model_name in bpt + bpt_deep

    ckpt = torch.load(args.finetune, map_location='cpu')['state_dict']
    ...
    trunc_normal_(model.head.weight, std=.01)
...
if __name__ == '__main__':  
    ...
    # model parameters
    parser.add_argument("--model_name", type=str, default="bpt_vit_b", help="architecture")
    ...
    # * MAE pretrain
    parser.add_argument('--finetune', type=str, default='./ckpt/MoCo/vit-b-300ep.pth', help='finetune from checkpoint')
